...
public sealed class RoundFacts
{
    ...
    private static ImmutableArray<string> NormalizeStrings(IEnumerable<string>? values)
    {
        return values?
            ...
            .OrderBy(value => value, IntentionsStringComparers.Ordering)
...
public sealed class AntagSummary
{
        ...
        ImmutableDictionary<string, int>? byObjectiveType = null)
    {
        ...
        ByRole = byRole ?? ImmutableDictionary<string, int>.Empty.WithComparers(IntentionsStringComparers.Equality);
        ByObjectiveType = byObjectiveType ?? ImmutableDictionary<string, int>.Empty.WithComparers(IntentionsStringComparers.Equality);
    }
